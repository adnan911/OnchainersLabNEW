...
const License = () => (
  <div className="min-h-screen bg-background text-foreground">
    <div className="max-w-[760px] mx-auto px-6 py-20 md:py-28">
      ...
      <p className="text-dim text-sm mb-10">Last Updated: March 13, 2026</p>

      <div className="space-y-8">
        {[
          { title: "1. License Grant", body: 'OnchainersLab ("Licensor") hereby grants you ("Licensee") a personal, non-exclusive, non-transferable, and limited license to download, install, and use the CryptoSpell mobile application ("Software") for personal, non-commercial purposes on mobile devices owned or controlled by you.' },
